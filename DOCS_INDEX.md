...
- [docs/design/NEWS_EXPERTS_METAPOLICY.md](docs/design/NEWS_EXPERTS_METAPOLICY.md)

## Implementation reports
- [docs/implementation/IMPLEMENTATION_REPORT.md](docs/implementation/IMPLEMENTATION_REPORT.md)
- [docs/implementation/FINAL_IMPLEMENTATION_REPORT.md](docs/implementation/FINAL_IMPLEMENTATION_REPORT.md)
- [docs/implementation/FINAL_DELIVERABLE.md](docs/implementation/FINAL_DELIVERABLE.md)
- [docs/implementation/AUDIT_SUMMARY.md](docs/implementation/AUDIT_SUMMARY.md)
- [docs/implementation/TASK_COMPLETION_SUMMARY.md](docs/implementation/TASK_COMPLETION_SUMMARY.md)
- [docs/implementation/MACOS_FIXES_SUMMARY.md](docs/implementation/MACOS_FIXES_SUMMARY.md)
...
## Navigation tips
- Start with the root [README.md](README.md) for overview, install, and workflows.
